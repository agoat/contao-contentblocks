...
// table callbacks
$GLOBALS['TL_DCA']['tl_article']['config']['oncopy_callback'][] = array('tl_content_article', 'copyRelatedValues');
$GLOBALS['TL_DCA']['tl_article']['config']['ondelete_callback'][] = array('tl_content_article', 'deleteRelatedValues');

	
class tl_content_article extends tl_article
{
	...
	public function copyRelatedValues ($intId, $dc)
	{
		...
		$colOrigContent = \ContentModel::findByPid($dc->id);
		$colNewContent = \ContentModel::findByPid($intId);
